							...
							<ul class="pagination">
								<ul class="pager">
									<li>
										...
										%>
												<a href="/baegopangAdmin/jsp/orderConfirmNegative.jsp?page=<%=startPage - 1%>">
													Previous
												</a>
										<%
												}else{
										...
										<% 
												...
												if (currentPage != startPage) {
										%>
													<a href="/baegopangAdmin/jsp/orderConfirmNegative.jsp?page=<%=currentPage - 1%>">
														Previous
													</a>
										<%
												}else{
									...
									<span> 
										<%
							 			...
							 			%> 
							 					<li>
							 						<a href="/baegopangAdmin/jsp/orderConfirmNegative.jsp?page=<%=i%>">
							 							<%=i %>
													</a>
												</li>
										<%
